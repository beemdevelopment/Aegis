...
public class DuoImporter extends DatabaseImporter {
    ...
    @Override
    @NonNull
    protected SuFile getAppPath() throws DatabaseImporterException, NameNotFoundException {
        return getAppPath(_pkgName, _subPath);
    }

    @Override
    @NonNull
    protected State read(@NonNull InputStream stream, boolean isInternal) throws DatabaseImporterException {
        try {
    ...
    public static class DecryptedState extends DatabaseImporter.State {
        ...
        @NonNull
        private static VaultEntry convertEntry(@NonNull JSONObject entry) throws DatabaseImporterEntryException {
            try {
                ...
                OtpInfo otp = counter == null ? new TotpInfo(secret) : new HotpInfo(secret, counter);
