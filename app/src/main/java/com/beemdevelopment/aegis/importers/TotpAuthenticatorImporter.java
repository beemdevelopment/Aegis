    ...
    public static class EncryptedState extends DatabaseImporter.State {
        ...
        protected DecryptedState decrypt(char[] password) throws DatabaseImporterException {
            try {
                ...
                return new DecryptedState(entries);
            } catch (NoSuchAlgorithmException | NoSuchPaddingException | InvalidAlgorithmParameterException | InvalidKeyException | BadPaddingException | IllegalBlockSizeException | JSONException e) {
                throw new DatabaseImporterException(e);
            }
        }
        ...
        public void decrypt(Context context, DecryptListener listener) {
            Dialogs.showSecureDialog(new AlertDialog.Builder(context).setMessage(R.string.choose_totpauth_importer).setPositiveButton(R.string.yes, (dialog, which) -> {
