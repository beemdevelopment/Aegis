...
public class AppearancePreferencesFragment extends PreferencesFragment {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        _resetUsageCountPreference.setOnPreferenceClickListener(preference -> {
            Dialogs.showSecureDialog(new AlertDialog.Builder(requireContext()).setTitle(R.string.preference_reset_usage_count).setMessage(R.string.preference_reset_usage_count_dialog).setPositiveButton(android.R.string.yes, (dialog, which) -> _prefs.clearUsageCount()).setNegativeButton(android.R.string.no, null).create());
            return true;
        });
        ...
        darkModePreference.setOnPreferenceClickListener(preference -> {
            ...
            Dialogs.showSecureDialog(new AlertDialog.Builder(requireContext()).setTitle(R.string.choose_theme).setSingleChoiceItems(R.array.theme_titles, currentTheme1, (dialog, which) -> {
        ...
        viewModePreference.setOnPreferenceClickListener(preference -> {
            ...
            Dialogs.showSecureDialog(new AlertDialog.Builder(requireContext()).setTitle(R.string.choose_view_mode).setSingleChoiceItems(R.array.view_mode_titles, currentViewMode1, (dialog, which) -> {
                int i = ((AlertDialog) dialog).getListView().getCheckedItemPosition();
