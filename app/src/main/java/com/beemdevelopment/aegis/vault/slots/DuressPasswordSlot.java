...
public class DuressPasswordSlot extends RawSlot {
    private boolean _repaired;

    private SCryptParameters _params;

    public DuressPasswordSlot() {
        super();
    }

    protected DuressPasswordSlot(UUID uuid, byte[] key, CryptParameters keyParams, SCryptParameters scryptParams, boolean repaired) {
